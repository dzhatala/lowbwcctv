...
//  private static final String UPLOAD_FILE_PATH = "Enter File Path";
  ...
  private static final String UPLOAD_FILE_PATH = "f:\\tmp";
  private static final String DIR_FOR_DOWNLOADS = "f:\\tmp";
  ...
  public static void main(String[] args) {
    Preconditions.checkArgument(
        ...
        "Please enter the upload file path and download directory in %s", new Object[]{DriveSample.class});

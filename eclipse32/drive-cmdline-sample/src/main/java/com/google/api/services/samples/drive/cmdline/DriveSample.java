...
public class DriveSample {
   ...
   */
  private static final String APPLICATION_NAME = "java_application";

  private static final String UPLOAD_FILE_PATH = ".\\resources\\testupload.jpg";
  private static final String DIR_FOR_DOWNLOADS = "./from_google_auto_api_upload";
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (uploadedFile !=null){
    	  View.header1("webview link:");
    	  View.header1(uploadedFile.getWebViewLink());
      }*/
...
//    Drive.Files.Insert insert = drive.files().insert(fileMetadata, mediaContent);
       ...
       String folderId="1dgUrvu6vv4TaUt9GhhtJHnw_CDp8XnaO";
  ...
  private static File updateFileWithTestSuffix(String id) throws IOException {
    ...
    fileMetadata.setName("java_upload" + UPLOAD_FILE.getName());
  ...
  private static void downloadFile(boolean useDirectDownload, File uploadedFile)
    ...
    if (!parentDir.exists() && !parentDir.mkdirs()) {
      throw new IOException("Unable to create parent destination directory");
    }
    ...
    */
    ...
    if(gFound!=null){
	    OutputStream out = new FileOutputStream(new java.io.File(parentDir, gFound.getName()));
	    drive.files().get(gFound.getId()).executeMediaAndDownloadTo(out);
	    out.close();
